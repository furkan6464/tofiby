...
export function toolRulesForAi(): string {
  return [
    ...
    "Kullanıcı tarih+saat+süreyi net verdiyse createTask'ı hemen çağır.",
    "Saat/gün belirsizse yine aracı çağır; istemci danışır. Sen rastgele saat seçme.",
    "Haftada yer kalmazsa geçmişe ekleme; kullanıcıya gelecek haftayı soracak sonuç döner.",
    "Yapamadığın eylemde (arkadaşlık, ödeme, silme) mutlaka navigateTo çağır; sayfa adını düz metinde bırakma.",
